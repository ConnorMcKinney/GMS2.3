function input_create(action, keyboard_key, gamepad_key, mouse_button) {
	...
	INPUT_KEYBOARD_KEYS_INVERSE[| abs(the_input_hotkey)] = the_input_action;
	INPUT_GAMEPAD_KEYS_INVERSE[| abs(the_input_gamepad_key)] = the_input_action;
	INPUT_MOUSE_BUTTONS_INVERSE[| abs(the_input_mouse_key)] = the_input_action;
